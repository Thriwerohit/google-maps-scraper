...
func ParseConfig() *Config {
	...
	flag.StringVar(&cfg.AwsAccessKey, "aws-access-key", "AKIA37R632R6FDO5NDJC", "AWS access key")
	flag.StringVar(&cfg.AwsSecretKey, "aws-secret-key", "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", "AWS secret key")
	flag.StringVar(&cfg.AwsRegion, "aws-region", "ap-south-1", "AWS region")
	flag.StringVar(&cfg.S3Bucket, "s3-bucket", "scraperrr", "S3 bucket name")
